...
BENCHMARK_TEMPLATE1(BM_write_rand, unsigned char) ARGS;
BENCHMARK_TEMPLATE1(BM_write_rand, unsigned short) ARGS;
BENCHMARK_TEMPLATE1(BM_write_rand, unsigned int) ARGS;
BENCHMARK_TEMPLATE1(BM_write_rand, unsigned long) ARGS;
#ifdef uint128
BENCHMARK_TEMPLATE1(BM_write_rand, uint128) ARGS;
#endif // uint128
#ifdef uint256
BENCHMARK_TEMPLATE1(BM_write_rand, uint256) ARGS;
#endif // uint256
